...
/**
 * PS 1.6 admin controller for the Tiresias admin tab.
 */
class AdminTiresiasController extends ModuleAdminController
{
	/**
	 * @inheritdoc
	 */
	public function initContent()
	{
		...
		Tools::redirectAdmin('index.php?controller=AdminModules&configure=tiresiastagging&token='.$token);
	}
}
