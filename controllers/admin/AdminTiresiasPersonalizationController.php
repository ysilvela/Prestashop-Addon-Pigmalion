...
require_once 'AdminTiresiasController.php';

/**
 * PS 1.5 admin controller for the Tiresias admin tab.
 */
class AdminTiresiasPersonalizationController extends AdminTiresiasController
{
