...
if (!defined('_PS_VERSION_'))
{
	...
	$controller_dir = $ps_dir.'/modules/tiresiastagging/controllers/front';
	...
	if (!empty($controller) && in_array($controller, $controller_white_list))
	{
		...
		ControllerFactory::getController('TiresiasTagging'.Tools::ucfirst($controller).'ModuleFrontController')->run();
	}
}
