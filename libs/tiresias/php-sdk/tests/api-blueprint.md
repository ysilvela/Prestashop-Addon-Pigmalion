...
+ Response 200 (application/json)
        ...
        {
            "login_url": "https://tiresias.com/auth/sso/sso%2Bplatform-00000000@tiresiassolutions.com/xAd1RXcmTMuLINVYaIZJJg"
        }

## Deleting Account [/hub/uninstall]

### Notify tiresias about deleted account [POST]
...
+ Parameters
    ...
    + cid (string) ... the tiresias customer id that placed the order
