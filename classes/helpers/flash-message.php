 ...
 */
class TiresiasTaggingHelperFlashMessage
{
	...
	public function add($type, $message)
	{
		...
		$cookie_data = isset($cookie->tiresiastagging) ? Tools::jsonDecode($cookie->tiresiastagging, true) : array();
		...
		$cookie->tiresiastagging = Tools::jsonEncode($cookie_data);
	}
