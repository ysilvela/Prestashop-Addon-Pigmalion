...
EOT;
			...
			$params = array('tiresiasdebug' => 'true');
...
EOT;
	...
	/**
	 * Get the Tiresias server address for the shop frontend JavaScripts.
	 *
	 * @return string the url.
	 */
	...
	public function getProductUrl($product, $id_lang = null, $id_shop = null, array $params = array())
	{
		...
		return TiresiasHttpRequest::replaceQueryParamsInUrl($params, $url);
	}
