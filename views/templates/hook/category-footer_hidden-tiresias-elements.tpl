...
<div class="hidden_tiresias_element" data-tiresias-id="tiresias-page-category1"></div>
<div class="hidden_tiresias_element" data-tiresias-id="tiresias-page-category2"></div>
