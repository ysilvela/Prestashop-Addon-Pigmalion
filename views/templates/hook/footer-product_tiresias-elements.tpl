...
<div class="tiresias_element" id="tiresias-page-product1"></div>
<div class="tiresias_element" id="tiresias-page-product2"></div>
<div class="tiresias_element" id="tiresias-page-product3"></div>
