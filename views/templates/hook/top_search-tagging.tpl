...
{if isset($tiresias_search) && is_object($tiresias_search)}
    <div class="tiresias_search_term" style="display:none">{$tiresias_search->getSearchTerm()|escape:'htmlall':'UTF-8'}</div>
{/if}
